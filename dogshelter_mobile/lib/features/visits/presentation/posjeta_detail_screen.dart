...
class _PosjetaDetailBodyState extends ConsumerState<_PosjetaDetailBody> {
  ...
  Future<void> _cancel() async {
    final reason = await showDialog<String>(
      context: context,
      builder: (dialogContext) => const CancelReasonDialog(title: 'Otkaži posjetu'),
    );
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            DetailRow(label: 'Datum kreiranja', value: formatDateTime(posjeta.datumKreiranja)),
            if (posjeta.datumObrade != null)
              DetailRow(label: 'Datum obrade', value: formatDateTime(posjeta.datumObrade!)),
